...
<div class="header">
	<div class="head clearfix">
		<div class="logo">
			<img src="/CBD/Assets/images/logo3.png" alt="CBD" />
		</div>
		<div class="head_r">
		 	<div class="widght">
			...
			<div class="h_rt">
				<span>咨询电话：<b>400-066-8939</b></span>在线人数：${lineCount } <span><span>${userLogin.userName},欢迎您&nbsp;
			</div>
			<ul class="nav clearfix">
				<li><a href="jumpHome">首页</a></li>
				<li><a href="/CBD/rentOutController_yg/turnToAddRentOutPage">我要出租</a></li>
				<li><a href="/CBD/rentIn_yg/turnToRentOutListPage">我要求租</a></li>
				<li><a href="jumpSaleCarport">我要出售</a></li>
				<li><a href="jumpBuyCarport">我要购买</a></li>
...
<div class="banner_img" id="b04">
	<ul>
		<li><img src="/CBD/Assets/upload/banner_a.jpg" alt="" width="1600"
			height="260"></li>
		<li><img src="/CBD/Assets/upload/banner_a.jpg" alt="" width="1600"
			height="260"></li>
		<li><img src="/CBD/Assets/upload/banner_a.jpg" alt="" width="1600"
