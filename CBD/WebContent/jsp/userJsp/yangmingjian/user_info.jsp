			...
			<div class="r_ctn clearfix">
				...
				<div class="ct">
					<form action="update" id="updateForm" method="post">
						...
						<p><label>家庭地址:</label><input class="form-control" type="text" name="userAddress" value="${userBean.userAddress }" required="required">${MessageAddress}</p>
						<p><label>电话号码:</label><input class="form-control" type="tel" name="userPhone" value="${userBean.userPhone }" required="required"></p>
						<p><label>身份证号码:</label>${userBean.userIdCard }</p>
						<p><label>职业描述:</label><input class="form-control" type="text" name="userProfession" value="${userBean.userProfession }" required="required">${MessageP}</p>
						<p><label>邮箱地址:</label><input class="form-control" type="email" name="userEmail" value="${userBean.userEmail }" required="required"></p>
						<p><input type="submit" value="提交" class="btn btn-info button"><a href="addReturn"><input type="button" value="返回" class="btn btn-info button"></a></p>
					</form>
				</div>
			</div>
		</div>
